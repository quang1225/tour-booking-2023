...
import { HEADER_ROUTES } from '../(Header)/DropdownPages'
...
const HeroSearchForm2Mobile = () => {
  const { setUserInput, userInput } = useAppContext()
  const {
    startDate,
    numberOfAdults = 0,
    numberOfChilds = 0,
                ...
                <Dialog.Panel className="relative h-full overflow-hidden flex-1 flex flex-col justify-between ">
                  {showDialog && (
                    <>
                      ...
                      <div className="pt-12 flex w-full font-semibold text-sm sm:text-base text-neutral-500 dark:text-neutral-400 space-x-6 sm:space-x-8">
                        <Logo className="w-24 mx-6" />

                        <ul className="flex space-x-6 sm:space-x-8 items-center">
