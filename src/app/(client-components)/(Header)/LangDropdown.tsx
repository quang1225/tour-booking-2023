                ...
                <div className="p-3 sm:p-6 rounded-2xl bg-white dark:bg-neutral-800 shadow-lg ring-1 ring-black ring-opacity-5">
                  <Tab.Group>
                    <Tab.List className="flex space-x-1 rounded-full bg-gray-100 dark:bg-slate-700 p-1">
                      {['Language', 'Currency'].map((category) => (
                        <Tab
                          key={category}
                          className={({ selected }) =>
                            `w-full rounded-full py-2 text-sm font-medium leading-5 text-gray-700 focus:outline-none focus:ring-0 ${
                              selected
                                ? 'bg-white shadow'
                    ...
                    <Tab.Panels className="mt-5">
                      <Tab.Panel className="rounded-xl p-3 focus:outline-none focus:ring-0 focus:outline-none focus:ring-0">
                        {renderLang(close)}
                      </Tab.Panel>
