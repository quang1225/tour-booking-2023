...
const ImageProduct: FC<AvatarProps> = ({
  ...
  return (
    <div
      className={`wil-avatar relative flex-shrink-0 inline-flex items-center justify-center text-neutral-100 uppercase font-semibold shadow-inner ${sizeClass} ${containerClassName}`}
      style={{
